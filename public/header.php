...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?5515b4404cb7b8dbc6786f5d8898c192";
    ...
    <ul class="j-barrager-list">
        <?php if ($comments->have()) : ?>
            <?php while ($comments->next()) : ?>
                <li>
                    <span class="j-barrager-list-avatar" data-src="<?php echo getavatar($comments->mail, $comments->authorId); ?>"></span>
        ...
        <div class="joe_container">
            ...
            <div class="joe_header__below-sign">
                <?php if ($this->user->hasLogin()) : ?>
                    <div class="joe_dropdown" trigger="click" style="float:right">
                        <div class="joe_dropdown__link">
                ...
                <?php endif; ?>
                <!-- 在线人数 -->
                <div class="item" style="float:right; margin-right: 15px; <?php if(Helper::options()->onlinePersion !== 'on') echo 'display:none;'  ?>">
                    <?php echo $tj ?>
                </div>
            </div>
            <!-- 弹幕 -->
...
<!-- 手机页面 -->
    <div class="joe_header__slideout" style="background-color: transparent">
        <div class="joe_header__slideout-author">
            <img width="50" height="50" class="avatar lazyload" src="<?php _getAvatarLazyload(); ?>" data-src="<?php echo $this->options->JAside_Author_Avatar ? $this->options->JAside_Author_Avatar() : getavatar($this->authorId ? $this->author->mail : $this->user->mail, $this->authorId) ?>" alt="博主昵称" />
            <div class="info" style="color: #36AAE8">
                <a class="link" style="color: #36AAE8" href="<?php $this->options->JAside_Author_Link() ?>" target="_blank" rel="noopener noreferrer nofollow"><?php $this->options->JAside_Author_Nick ? $this->options->JAside_Author_Nick() : ($this->authorId ? $this->author->screenName() : $this->user->screenName()); ?>(<?php get_last_login(1); ?> 在线)</a>
                <span>都将万事，付与千钟。</span>
            </div>
        </div>
         <!-- 联系方式开始 -->
        <div class="joe_header__slideout-lxfs">
            <div>
                <svg t="1626268575501" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1176" width="33" height="33">
                    <a xlink:href="https://t.me/Wayne_3301" target="_blank">
                    <path d="M1024 512c0 281.6-230.4 512-512 512S0 793.6 0 512 230.4 0 512 0s512 230.4 512 512z" fill="#36AAE8" p-id="1177"></path><path d="M696.32 778.24l102.4-486.4c10.24-40.96-15.36-61.44-46.08-51.2L148.48 471.04c-40.96 15.36-40.96 40.96-5.12 51.2l153.6 51.2 363.52-230.4c15.36-10.24 30.72-5.12 20.48 5.12L389.12 614.4l-10.24 158.72c15.36 0 25.6-5.12 30.72-15.36l76.8-71.68 158.72 117.76c25.6 15.36 46.08 5.12 51.2-25.6z" fill="#FFFFFF" p-id="1178">
                    </path>
                    </a>
                </svg>
            </div>
            <div>
                <svg t="1626268892388" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1388" width="33" height="33">
                    <a xlink:href="mailto:wuw@gmx.com" target="_blank">
                    <path d="M505.856 0C226.494512 0 0 226.470698 0 505.856c0 279.361488 226.470698 505.856 505.856 505.856 279.361488 0 505.856-226.470698 505.856-505.856C1011.712 226.494512 785.241302 0 505.856 0z" fill="#36AAE8" p-id="1389"></path><path d="M738.232558 407.575814V642.976744c0 26.195349-21.432558 47.627907-47.627907 47.627907H309.581395c-26.195349 0-47.627907-21.432558-47.627907-47.627907l0.23814-235.28186 232.186046 126.666418a11.906977 11.906977 0 0 0 11.430698 0L738.232558 407.575814zM690.604651 309.581395c26.004837 0 47.318326 21.122977 47.627907 47.056372l-238.020465 133.000931-238.020465-132.881861A47.556465 47.556465 0 0 1 309.581395 309.581395h381.023256z" fill="#FFFFFF" p-id="1390">
                    </path>
                    </a>
                </svg>
            </div>
            <div>
                <svg t="1626269002097" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1388" width="33" height="33">
                    <a xlink:href="https://www.youtube.com/channel/UCPEKdqBXXgij_9byYzp-oag" target="_blank">
                    <path d="M512.29007303 1021.22001977c281.24784754 0 509.25030855-228.00246101 509.25030855-509.23516473 0-281.21522859-228.00246101-509.20603989-509.25030855-509.20603989-281.24551737 0-509.22001977 227.99081131-509.22001863 509.20603989 0 281.23386766 227.9745024 509.23516359 509.22001863 509.23516473" fill="#36AAE8" p-id="1389"></path><path d="M599.154143 512.218088l-146.531301 86.062681V426.14312l146.531301 86.074968z m136.892444 79.792407V431.989505s0-77.134401-77.14464-77.134401H365.584399s-77.094469 0-77.09447 77.134401v160.019966s0 77.12109 77.09447 77.12109h293.318572c-0.001024 0 77.143616 0 77.143616-77.120066" fill="#FFFFFF" p-id="1390">
                    </path>
                    </a>
                </svg>
            </div>
            <div>
                <svg t="1626269349339" class="icon" viewBox="0 0 2291 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2043" width="33" height="33">
                    <a xlink:href="tel:+13208030080" target="_blank">
                    <path d="M1149.87627983 506.66666667m-1146.28733292 0a1146.28733288 1146.28733288 0 1 0 2292.57466578 0 1146.28733288 1146.28733288 0 1 0-2292.57466578 0Z" fill="#36AAE8" p-id="2044"></path><path d="M1298.74476573 779.09599409l38.70580676-23.81895746c12.65382106-8.18776698 26.05198565-14.88684929 40.1944892-21.58593157 87.08806293-39.45014798 164.49967642-11.90947982 265.73024514 107.1853098 63.26910546 73.68990063 81.87766759 139.19203423 57.31436662 197.25074208-17.8642187 43.17186084-52.84831252 73.68990063-115.37307449 110.16267919l-49.12659966 29.02935506c-144.40242958 89.3210911-476.37915184-114.62873329-714.56872664-464.46967419-238.93391828-349.84093867-301.45868246-723.50083708-154.82322471-814.31061066l19.35290338-12.65382109 20.84158806-13.39816456c74.43424185-47.63791497 121.32781556-66.99081834 177.89783872-57.31436661 55.82568196 9.67645169 104.20794036 51.35962781 144.4024296 126.53821314 84.855037 160.03362008 66.24647484 235.95654885-43.17186087 305.18039312-8.18776698 5.21039758-35.72843732 22.33027278-38.70580449 23.81895748-26.79632688 16.37553397 18.6085599 128.02689785 124.30518274 282.85012261 107.92965103 158.54493538 197.25074215 244.14431587 227.02444064 225.53575366z" fill="#FFFFFF" p-id="2045">
                    </path>
                    </a>
                </svg>
            </div>
            ...
            <li>
                <?php if ($this->user->hasLogin()) : ?>
                    ...
                    <ul class="slides panel-body">
                        ...
                        <li>
                            <a class="link" href="<?php $this->options->logoutUrl(); ?>">退出登录</a>
                        </li>
                    </ul>
                <?php else : ?>
                    <a class="link panel" href="#" rel="nofollow">
        ...
        <?php if ($this->options->LoveTime) :  ?>
            ...
            <ul class="joe_header__slideout-count">
                <div id="lovexhj" style="width: 100%; height: 100%; text-align: center; font-size: 1rem;">
                    ...
                    <p id="loveSitetime4Header" style="font-size: 1.0rem;color:red;"></p>
                </div>
            </ul>
