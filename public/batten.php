...
<div class="joe_detail__count">
    <div class="joe_detail__count-information">
        <img width="35" height="35" class="avatar lazyload" src="<?php _getAvatarLazyload(); ?>" data-src="<?php echo getavatar($this->author->mail, $this->authorId); ?>" alt="<?php $this->author(); ?>" />
        <div class="meta">
            <div class="author">
    ...
    <time class="joe_detail__count-created" style="font-size:20px"><?php echo date('Y-m-d', $this->modified); ?></time>
</div>