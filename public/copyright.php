...
<div class="joe_detail__copyright" style="<?php if(Helper::options()->CopyRightContent !== 'on') echo 'display:none;'  ?>">
    <div class="content">
        <div class="item">
            ...
            <span class="text">转载本网站任何内容，请标明作者并附带本站原文地址。</span>
        </div>
        <div class="item">
            <svg t="1625899848989" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1965" width="20" height="20"><path d="M512 513.4m-192 0a192 192 0 1 0 384 0 192 192 0 1 0-384 0Z" fill="#249FF8" p-id="1966"></path></svg>
            <span class="text">本站资源部分来自网络，如涉及版权问题请及时与站长联系。</span>
        </div>
        <div class="item">
            <svg t="1625899848989" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1965" width="20" height="20"><path d="M512 513.4m-192 0a192 192 0 1 0 384 0 192 192 0 1 0-384 0Z" fill="#249FF8" p-id="1966"></path></svg>
...
<div class="joe_detail__copyright">
    <div class="content">
        ...
        <div class="item">
            <svg t="1625234183839" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="974" width="200" height="200"><path d="M512 0c282.784 0 512 229.216 512 512s-229.216 512-512 512S0 794.784 0 512 229.216 0 512 0z m48 176h-64v384H800v-64h-240v-320z" fill="#d4237a" p-id="975"></path></svg>
            <span>最后修改：</span>
            <span class="text"><?php echo date('Y-m-d H:i', $this->modified); ?> UTC+8</span>
        </div>
        <div class="item">
            <svg class="icon" width="20" height="20" viewBox="0 0 1024 1024">
        ...
        <div class="item">
            ...
            <span>作品声明：</span>
            <span class="text">全文转载、部分引用、二次演绎请标明作者并附带本文链接</span>
        </div>
    </div>
</div>
