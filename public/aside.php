<aside class="joe_aside">
    <section class="joe_aside__item author">
        ...
        <div class="user">
            <img width="75" height="75" class="avatar lazyload" src="<?php _getAvatarLazyload(); ?>" data-src="<?php echo $this->options->JAside_Author_Avatar ? $this->options->JAside_Author_Avatar() : getavatar($this->authorId ? $this->author->mail : $this->user->mail, $this->authorId) ?>" alt="博主头像" />
            ...
            <div style="color : #36AAE8">
                <?php get_last_login(1); ?> 在线
            </div>
            <!-- 新增联系方式 -->
            <div style="margin:15px 0px 15px 0px">
                <div style="float:left">
                    <svg t="1626268575501" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1176" width="30" height="30">
                ...
                <div style="float:left; margin-left: 15px">
                    <svg t="1626268892388" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1388" width="30" height="30">
                ...
                <div style="float:left; margin-left: 15px">
                    <svg t="1626269002097" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1388" width="30" height="30">
                ...
                <div style="float:left; margin-left: 15px">
                    <svg t="1626269349339" class="icon" viewBox="0 0 2291 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2043" width="30" height="30">
    ...
    <?php if ($this->options->LoveTime) :  ?>
        ...
        <section class="joe_aside__item">
            <ul class="joe_header__slideout-count" style="margin-bottom: 0px;">
                <div id="lovexhj" style="width: 100%; height: 100%; text-align: center; font-size: 1rem;">
                    ...
                    <p id="loveSitetime4Aside" style="font-size: 1.0rem;color:red;"></p>
                </div>
            </ul>
        </section>
    ...
    <?php if ($this->options->JAside_Timelife_Status === 'on') : ?>
        <section class="joe_aside__item timelife">
            <div class="joe_aside__item-title">
                ...
                <span class="text" style="color:red;font-size:14px;">但一回醉，一回病，一回慵</span>
            </div>
                ...
                <ul class="hunter-authors">
                        <?php
                            ...
                            foreach ($counts as $count) {
                                $c_url = '<li><div class="item"><div class="hunter-avatar"><div class="vatar"><img src="' . getavatar($count['mail'], $count['authorId']) . '"></div></div><div class="item-main"><div><a target="_blank" href='. $count['url'] . '>' . $count['author'] . '</a>';
                                echo '' . $c_url . '';
                                autvip($count['mail']);
    ...
    <?php if ($this->options->JAside_3DTag === 'on') : ?>
        <section class="joe_aside__item tags">
            <div class="joe_aside__item-title">
                ...
                <span class="text" style="color:red;font-size:14px;">任酒花白，眼花乱，烛花红</span>
            </div>
